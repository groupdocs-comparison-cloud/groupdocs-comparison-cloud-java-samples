package examples.Working_With_Comparisons;
...
public class Comparison_Java_Get_Changes_Multiple_Documents {
	...
	public static void main(String[] args) {
		...
		try {
			...
			List<ChangeInfo> response = apiInstance.postChanges(request);
			System.out.println("Expected response type is List<ChangeInfo>: " + response.size());
